...
public class Medium {
    ...
    /**
     * method to find Single Element in a Sorted Array
     * TC - O(logn)
     * SC - O(1)
     */
    ...
    /**
     * method to search an element in a 2D matrix - II
     * TC - O(n+m)
     * SC - O(1)
     */
    ...
    /**
     * method to find a Peak Element - II
     * TC - O(n log m)
     * SC - O(1)
     */
    private int findMax(int[][] matrix, int j) {
...
//        int[] nums = {4, 5, 6, 7, 0, 1, 2};
        ...
        // }
//        System.out.println(medium.searchMatrix2(nums, 20));
//        System.out.println(medium.findMin(nums));
        ...
        System.out.println(Arrays.toString(medium.findPeakGrid(nums)));
    }
}